...
(function (global, factory) {
  ...
  Parsley.addMessages('en', {
    defaultMessage: "Nilai tidak valid.",
    type: {
    ...
    minlength: "Terlalu Pendek. Harus Lebih dari %s Karakter.",
    maxlength: "Terlalu Panjang. Harus Kurang dari %s Karakter.",
    length: "Jumlah karakter harus antara %s dan %s ",

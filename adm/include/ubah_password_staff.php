...
<hr>
      ...
      <h5><b><?php echo date("l, M Y"); ?></b></h5>
			<center><h2>Ubah Password Staff Produksi</h2></center>
            ...
            <br><br>
              ...
              <div class="box box-info">
                <div class="box-header">
                  <i class="fa fa-add"></i>
                  <h3 class="box-title">Ubah Password Staff Produksi</h3>
              ...
              if (isset($_POST['simpan'])) {
                ...
                if (password_verify($last_password,$rows['password'])) {
                  if ($new_password == $conf_password) {
                    ...
                    if ($query) {
                      echo "<script>alert('Berhasil Ubah Password staff produksi')</script>";

          ...
          <ol class="breadcrumb">
            ...
            <li><a href="#"><i class="fa fa-plus"></i> Tambah Alat</a></li>
          </ol>
...
<hr>
      ...
      <a href="index.php?page=2" class="btn btn-primary"><i class="fa fa-arrow-circle-left"></i> Kembali</a>
                ...
                <div class="box-body">
                  <form action="#" method="post">
                    ...
                    <div class="form-group">
                      ...
                      <textarea name="keterangan" id="keterangan" cols="30" rows="10" class="form-control" placeholder="Keterangan Alat"></textarea>
                    </div>
            ...
            if ($nm_barang == "") {
                ...
                $query = mysqli_query($conn, "INSERT INTO Alat VALUES('$kode2','$nm_barang','$keterangan')");
                if ($query) {

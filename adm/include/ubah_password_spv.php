...
<hr>
      ...
      <?php
        $query_updt = mysqli_query($conn,"SELECT * FROM admin WHERE username='$username' and role='SPV'");
        if ($query_updt) {
            ...
            <br><br>
              ...
              <div class="box box-info">
                <div class="box-header">
                  <i class="fa fa-add"></i>
                  <h3 class="box-title">Ubah Password Pegawai</h3>
              ...
              if (isset($_POST['simpan'])) {
                ...
                if (password_verify($last_password,$rows['password'])) {
                  if ($new_password == $conf_password) {
                    ...
                    if ($query) {
                      echo "<script>alert('Berhasil Ubah Password SPV')</script>";
                      echo "<script>window.location = 'index.php?page=8'</script>";
                    }else{
                      echo "<script>alert('Gagal Ubah Password SPV')</script>";

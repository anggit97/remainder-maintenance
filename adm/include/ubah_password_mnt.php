			   <h1>
            Ubah Password Staff Maintenance
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-magic"></i> SPV</a></li>
            <li><a href="#"><i class="fa fa-plus"></i> Ubah Password SPV</a></li>
          </ol>
...
<hr>
      ...
      <h5><b><?php echo date("l, M Y"); ?></b></h5>
			<center><h2>Ubah Password Staff Maintenance</h2></center>
            ...
            <br><br>
              ...
              <div class="box box-info">
                <div class="box-header">
                  <i class="fa fa-add"></i>
                  <h3 class="box-title">Ubah Password Staff Maintenance</h3>
              ...
              if (isset($_POST['simpan'])) {
                ...
                if (password_verify($last_password,$rows['password'])) {
                  if ($new_password == $conf_password) {
                    ...
                    $query = mysqli_query($conn, "UPDATE admin SET password='$hash' WHERE username='$username'");
                    if ($query) {
                      echo "<script>alert('Berhasil Ubah Password staff maintenance')</script>";
                      echo "<script>window.location = 'index.php?page=11'</script>";
                    }else{
                      echo "<script>alert('Gagal Ubah Password staff produksi')</script>";
                      echo "<script>window.location = 'index.php?page=24&&usr=$username'</script>";
                    } 

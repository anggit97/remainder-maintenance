                  ...
                  <form action="" method="post">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                      ...
                      <select name="solusi" id="solusi" class="form-control">
                        ...
                        <option value="servis"
                         <?php  
                        if ($rows['solusi'] == 'servis') {
                          echo "selected";
                        }
                        ?>>Servis</option>
                        <option value="belibaru" <?php  
                        if ($rows['solusi'] == 'belibaru') {
                          echo "selected";
                        }
                        ?>>Beli Baru</option>
                      </select>
                    ...
                    <div class="form-group">
                      <div id="desc">
                        ...
                        <textarea name="deskripsi" id="deskripsi" cols="30" rows="10" placeholder="deskripsi" class="form-control"><?php echo $rows['deskripsi']; ?></textarea>
                      </div>
                    </div>
                </div>

            ...
            <br><br>
                ...
                <div class="box-body">
                  <form action="#" method="post">
                    ...
                    <div class="form-group">
                      ...
                      <input type="date" class="form-control" name="tgl_maintenance" id="tgl_maintenance" value="<?php echo $rows['tgl_maintenance']; ?>" placeholder="Tanggal Maintenance">
                    </div>
                    <div class="form-group">
                     ...
                     <div class="form-group">
                      ...
                      <input type="date" class="form-control" name="tgl_maintenance_sel" id="tgl_maintenance_sel" placeholder="Tanggal Maintenance Selanjutnya" value="<?php echo $rows['tgl_maintenance_selanjutnya']?>">
                    </div>
                </div>
              ...
              if (isset($_POST['simpan'])) {
                ...
                if ($tgl_maintenance == "") {
                    ...
                    $query = mysqli_query($conn, "UPDATE maintenance SET tgl_maintenance='$tgl_maintenance',id_pegawai='$id_pegawai',tgl_maintenance_selanjutnya='$tgl_maintenance_sel' WHERE id_maintenance='$id_maintenance'");
                    if ($query) {

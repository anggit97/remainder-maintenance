<?php
      ...
      $query = mysqli_query($conn,"SELECT * FROM admin where username='$username' and role='SPV'");
      if ($query) {
        $data = mysqli_fetch_array($query);
                ...
                if (isset($_GET['page'])) {
                    ...
                    case '13':
                      ...
                      break;
                    case '17':
                      $includeVal = "include/buat_surat_jalan.php";
                      $no_po_salin = $_GET['no_po_salin'];
                      $no_sj = $_GET['no_sj'];
                      $active5 = "active";
                      break;
                    case '18':
                      $includeVal = "include/cetak_sj.php";
                      $no_po_salin = $_GET['no_po_salin'];
                      $no_sj = $_GET['no_sj'];
                      $active5 = "active";
                      break;
...
<html>
  <head>
    ...
    <title>Remainder Maintenance | SPV</title>
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="header" type="button" data-toggle="collapse" data-target="#demo2"><i class="fa fa-archive"></i> &nbsp;&nbsp;MASTER <span class="caret" style="float: right;margin-top: 10px;"></li>
            <div class="collapse" id="demo2">
            <li class="<?php echo $active3; ?> treeview">
              <a href="index.php?page=5">&nbsp;&nbsp;&nbsp;&nbsp;
                <i class="fa fa-user"></i> <span>Kelola Pegawai</span>
              </a>
            </li>
            </div>
            <li class="header" type="button" data-toggle="collapse" data-target="#demo3"><i class="fa fa-clipboard"></i> &nbsp;&nbsp;TRANSAKSI <span class="caret" style="float: right;margin-top: 10px;"></li>
            <div class="collapse" id="demo3">
            <li class="<?php echo $active4; ?> treeview">
              <a href="index.php?page=8">&nbsp;&nbsp;&nbsp;&nbsp;
                <i class="fa fa fa-cogs"></i> <span>Pengajuan Maintenance</span>
              </a>
            </li>
            </div>
            <li class="header">

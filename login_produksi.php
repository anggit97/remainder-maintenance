...
if (isset($_POST['login'])) {
	...
	$query = mysqli_query($conn, "SELECT password from admin where username='$username' and role='Staff Produksi'");
	...
	if ($query) {
		...
		if (mysqli_num_rows($query)>0) {
			...
			if (password_verify($password,$data['password'])) {
				...
				header("location:staff_produksi");
				exit;
...
<head>
	<meta charset="UTF-8">
	<title>Login Staff Produksi</title>
	    ...
	    <div class="col-md-4">
	      ...
	      <section class="login-form">
	        <form method="post" action="" role="login">
			  ...
			  <center><h3>Login Staff Produksi</h3></center>
	          ...
	          <div>
	            ...
	            <a href="login_spv.php">Login SPV</a>
	          </div>

...
<html>
  <head>
    ...
    <title>Remainder Maintenance | Staff Produksi</title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="#" class="logo">
          ...
          <span class="logo-lg">Staff Produksi</span>
        </a>
      ...
      <aside class="main-sidebar">
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="header" type="button" data-toggle="collapse" data-target="#demo2"><i class="fa fa-user"></i> &nbsp;&nbsp;DATA DIRI <span class="caret" style="float: right;margin-top: 10px;"></li>
            ...
            <li class="header" type="button" data-toggle="collapse" data-target="#demo1"><i class="fa fa-clipboard"></i> &nbsp;&nbsp;TRANSAKSI <span class="caret" style="float: right;margin-top: 10px;"></span></li>

...
<a href="index.php?page=9" class="btn btn-primary btn-lg"><span class="glyphicon glyphicon-plus"></span> Input Pengajuan Maintenance</a><br><br>
...
?>
			<tr>
                ...
                <td>
                    <a style="margin: 3px;" class="btn btn-success col-sm-12" href="index.php?page=11&&id_maintenance=<?php echo $rows['id_maintenance']; ?>"><i class="fa fa-pencil"></i> Edit</a> 
                    <a style="margin: 3px;" class="btn btn-danger col-sm-12" href="#" data-toggle="modal" data-target="#confirm-delete_<?php echo $rows['id_maintenance']; ?>"><i class="fa fa-trash"></i> Hapus</a>
                    <a style="margin: 3px;" class="btn btn-info col-sm-12" href="index.php?page=10&&id_maintenance=<?php echo $rows['id_maintenance']; ?>"><i class="fa fa-plus"></i> Input Kerusakan</a>
                </td>
			</tr>

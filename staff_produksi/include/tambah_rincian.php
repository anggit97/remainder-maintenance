                ...
                <div class="box-body">
                  <form action="#" method="post">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" name="id_kerusakan" placeholder="ID Kerusakan" class="form-control" value="<?php echo $kode2; ?>" readonly="readonly">
                    </div>
                    <div class="form-group">
                      <label for="sel1">Kerusakan</label>
                      <input type="text" name="kerusakan" placeholder="Kerusakan" class="form-control">
                    </div>
<!--                     <div class="form-group">
                      <label for="sel1">Deskripsi Kerusakan</label>
                      <textarea name="deskripsi" class="form-control" cols="30" rows="10" placeholder="Deskripsi Kerusakan"></textarea>
                    </div>
                     <div class="form-group">
                      <label for="sel1">Solusi Kerusakan</label>
                      <textarea name="solusi" id="solusi" class="form-control" cols="30" rows="10" placeholder="Solusi Kerusakan"></textarea>
                    </div> -->
                </div>
            ...
            if($id_alat == "") {
                ...
                echo "<script>alert('Kerusakan Harus diisi!')</script>";
            }
            // elseif($deskripsi == ""){
            //     echo "<script>alert('deskripsi kerusakan Harus diisi!')</script>";
            // }elseif($solusi == ""){
            //     echo "<script>alert('Solusi Harus diisi!')</script>";
            // }
            else{
              $query = mysqli_query($conn, "INSERT INTO alat_kerusakan VALUES(null,'$id_mainetanance','$id_alat','$id_kerusakan','')");
              $query2 = mysqli_query($conn, "INSERT INTO kerusakan VALUES('$id_kerusakan','$kerusakan','','belum diproses')");
              if ($query) {
